...
<div class="background-login">
    ...
    <div class="container-login z-20">
            ...
            <form method="POST" action="/register">
                ...
                <input type="password" id="conferma" name="password_confirmation" class="input-text mb-12" minlength="8" required>
                <input type="hidden" name="role" value="student">
                <input type="submit" value="REGISTRATI" class="block button-login">
            </form>
    </div>
</div>
@endsection

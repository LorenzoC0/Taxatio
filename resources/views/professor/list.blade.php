...
@section('body')
    <div class="w-full h-full bg-amber-100 p-4 space-y-3">
        <div class="flex flex-row justify-between h-[50px] mb-10">
        ...
        <div class="flex h-[50px] bg-[#EED9FE] text-lg rounded-xl my-auto">
            <div class="flex w-[50px] justify-center text-2xl font-medium items-center">
                <p>1</p>
            </div>
            <div class="flex w-full justify-around my-auto">
                <p class="w-[180px]">Giacomo</p>
                <p class="w-[180px]">Alberini</p>
                <p class="w-[180px] pl-10">6,7</p>
                <p class="w-[180px]">Disponibilità</p>
                <p class="w-[180px]">Disponibilità</p>
            </div>
        </div>
        ...
        <div class="flex w-full h-[50px] bg-[#FFE9CF] text-lg rounded-xl my-auto">
            ...
            <div class="flex w-full justify-around my-auto">
                <p class="w-[180px]">Giacomo</p>
                <p class="w-[180px]">Alberini</p>
                <p class="w-[180px] pl-10">3,0</p>
                <p class="w-[180px]">Materiale didattico</p>
                <p class="w-[180px]">Materiale didattico</p>
            </div>
        </div>

        <div class="flex w-full h-[50px] bg-[#EED9FE] text-lg rounded-xl my-auto">
            <div class="flex w-[50px] justify-center text-2xl font-medium items-center">
                <p>3</p>
            </div>
            <div class="flex w-full justify-around my-auto">
